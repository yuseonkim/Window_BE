    ...
    public ApiResponse<?> processGPT2(@RequestBody UserInputDTO userInputDTO, @AuthenticationPrincipal PrincipalDetails principalDetails) {
        ...
        role.setContent(
                "- Language: Korean (Default) \n" +
                        ...
                        " \n" +
                        "목표: 사용자가 생각하는 물건, 동물, 개념 등을 추측하기 위해 예 또는 아니오 질문으로 이끄는 다섯고개 게임을 만듭니다. \n" +
                        ...
                        "\n" +
                        "카테고리 선택: \n" +
                        "- 사용자가 선택할 수 있는 카테고리 목록(동물, 물건 등)을 제시합니다. \n" +
                        ...
                        "\n" +
                        "질문 루프: \n" +
                        "- 선택한 카테고리를 기반으로 예 또는 아니오 질문을 시작합니다. \n" +
    ...
    public ApiResponse<?> processGPT1(@RequestBody UserInputDTO userInputDTO,
        ...
        role.setContent(
                "- Language: Korean (Default) \n" +
                        ...
                        "역할: 너는 다섯고개 게임의 게임 마스터이다. 초등학교 저학년 수준의 아이와 게임을 한다.\n" +
                        " \n" +
                        "목표: AI가 생각하는 물건, 동물, 개념 등을 추측하기 위해 사용자가 예 또는 아니오 질문을 하는 다섯고개 게임을 만듭니다. \n" +
                        "사용자의 이름은 " + userName + "이다. \n" +
                        "\n" +
                        " ChatGPT 지침: \n" +
                        "게임 시작: \n" +
